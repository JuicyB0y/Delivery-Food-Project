...
const HomeContainer = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full items-top" id="home">
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <p
          className="text-base text-textColor text-center lg:text-left
          md:w-[80%]">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia, est magni. Minima deserunt sint dolores tempore
          dolorem ipsum eveniet, quibusdam sapiente quas dolore error aut, amet ex eius nulla voluptas!
        </p>
      ...
      <div className="py-2 flex-1 flex items-center relative">
        ...
        <div
         ...
         justify-center py-4 gap-4 flex-wrap lg:px-32">
          {heroData &&
            heroData.map((item) => (
              <div
                key={item.id}
                className="lg:w-190 p-4 bg-cardOverlay backgdrop-blur-md rounded-3xl flex flex-col
          items-center justify-center frop-shadow-lg">
                <img src={item.imageSrc} className="w-20 lg:w-40 -mt-10 lg:-mt-20 " alt="I1" />
                <p className="text-base lg:text-xl font-semibold text-textColor lg:mt-4">{item.name} </p>
